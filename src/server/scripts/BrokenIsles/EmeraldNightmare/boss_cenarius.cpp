...
enum Spells
{
    ...
    SPELL_NIGHTMARE_BRAMBLES = 210290, // every 30sec
...
public:
    ...
    struct boss_cenariusAI : public ScriptedAI
    {
        boss_cenariusAI(Creature* creature) : ScriptedAI(creature), Summons(me) { }
...
class rotten_drake : public CreatureScript
{
public:
    rotten_drake() : CreatureScript("rotten_drake") { }

    struct rotten_drakeAI : public ScriptedAI
    {
        rotten_drakeAI(Creature* creature) : ScriptedAI(creature), Summons(me) { }
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new rotten_drakeAI(creature);
    }
};

class twisted_sister : public CreatureScript
{
public:

    twisted_sister() : CreatureScript("twisted_sister") { }

    struct twisted_sisterAI : public ScriptedAI
    {
        twisted_sisterAI(Creature* creature) : ScriptedAI(creature), Summons(me) { }
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new twisted_sisterAI(creature);
    }
};

class nightmare_ancient : public CreatureScript
{
public:
    nightmare_ancient() : CreatureScript("nightmare_ancient") { }

    struct nightmare_ancientAI : public ScriptedAI
    {
        nightmare_ancientAI(Creature* creature) : ScriptedAI(creature), Summons(me) { }
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new nightmare_ancientAI(creature);
    }
};

class brambles : public CreatureScript
{
public:
    brambles() : CreatureScript("brambles") { }

    struct bramblesAI : public ScriptedAI
    {
        bramblesAI(Creature* creature) : ScriptedAI(creature), Summons(me) { }
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new bramblesAI(creature);
    }
};

class tormented_souls : public CreatureScript
{
public:
    tormented_souls() : CreatureScript("tormented_souls") { }

    struct tormented_soulsAI : public ScriptedAI
    {
        tormented_soulsAI(Creature* creature) : ScriptedAI(creature), Summons(me) { }
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new tormented_soulsAI(creature);
    }
};

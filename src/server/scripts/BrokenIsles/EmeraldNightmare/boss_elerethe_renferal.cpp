...
public:
    ...
    struct boss_elerethe_renferalAI : public ScriptedAI
    {
        boss_elerethe_renferalAI(Creature* creature) : ScriptedAI(creature), Summons(me) { }
